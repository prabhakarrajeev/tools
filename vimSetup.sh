...
echo "silent s/^/\#/" >> ~/.vimrc
echo "elseif ext == 'js' || ext == 'scala' || ext == 'cpp' || ext == 'c' || ext == 'h'" >> ~/.vimrc
...
## Command-T
echo "Installing Command-T - execute this within vim:  :call pathogen#helptags()"
sudo apt-get install vim-nox  # ruby support
sudo apt-get install ruby-dev # ruby support
